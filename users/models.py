...
class CustomUser(AbstractUser):
    ...
    telegram = models.CharField(verbose_name='Телеграмм', max_length=255, blank=True)
    telegram_id = models.CharField(verbose_name='Телеграмм id', max_length=255, blank=True)
