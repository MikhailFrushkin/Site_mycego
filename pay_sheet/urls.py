...
from pay_sheet.views import PaySheet, created_salary_check, PaySheetListView, PaySheetDetailView
...
urlpatterns = [
    ...
    path('pay_sheet/<int:pk>/', PaySheetDetailView.as_view(), name='pay_sheet_detail'),
]
